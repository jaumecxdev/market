                                ...
                                @foreach($order->order_items as $order_item)
                                    <tr order_item-id="{{ $order_item->id }}">
                                        @if ($order_item->product)
                                            ...
                                            <td style="width: 8%">{{ $order_item->cost }} {{ $order_item->currency->code }}<br>
                                                {{ $order_item->price }} {{ $order_item->currency->code }}</td>

                                            <td style="width: 8%">{{ $order_item->bfit }} {{ $order_item->currency->code }}<br>
                                                {{ $order_item->mps_bfit }} {{ $order_item->currency->code }}<br>
                                                {{ $order_item->mp_bfit }} {{ $order_item->currency->code }}</td>

                                                <td>{{ $order_item->product->stock }}</td>
                                        ...
                                        @else
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td style="width: 8%">??? {{ $order_item->currency->code }}<br>
                                                {{ $order_item->price }} {{ $order_item->currency->code }}</td>
                                            <td style="width: 8%"></td>
                                            <td></td>
                                            <td>{{ $order_item->quantity }}</td>
