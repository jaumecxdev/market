    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12"><h1>{{ isset($buyer) ? 'EDITAR COMPRADOR: ' .$buyer->name : 'AÑADIR COMPRADOR' }}</h1></div>
                </div>
            </div>
        </section>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (isset($buyer))
                                <form method="post" action="{{ route('saas.buyers.update', [$buyer]) }}">
                                    @method('PATCH')
                            @else
                                <form method="post" action="{{ route('saas.buyers.store') }}">
                            @endif
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-danger" href="{{ route('saas.orders') }}" role="button">Cancelar</a>
