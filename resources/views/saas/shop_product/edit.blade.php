    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12"><h1>{{ isset($shop_product) ? 'EDITAR PRODUCTO DE TIENDA: ' .$shop_product->product->name : 'AÑADIR PRODUCTO DE TIENDA' }}</h1></div>
                </div>
            </div>
        </section>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('saas.shops.shop_products.update', [$shop, $shop_product]) }}">
                                @method('PATCH')
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="param_fee" class="col-sm-2 col-form-label">Margen Bcio | Mín | RePrice Mín</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <a class="btn btn-danger" href="{{ route('saas.shops.shop_products', $shop) }}" role="button">Cancelar</a>
