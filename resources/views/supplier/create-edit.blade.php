    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-10"><h1>{{ isset($supplier) ? 'EDITAR PROVEEDOR: ' .$supplier->name : 'AÑADIR PROVEEDOR' }}</h1></div>
                    <div class="col-sm-2">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <a class="btn btn-danger" href="{{ route('suppliers.index') }}" role="button">Cancelar</a>
